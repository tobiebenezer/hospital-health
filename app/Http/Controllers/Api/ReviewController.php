...
class ReviewController extends Controller
{
     ...
     *   @OA\Response(response=200, description="OK", @OA\JsonContent(type="array", @OA\Items(ref="#/components/schemas/Review")))
     * )
     */
     ...
     *   @OA\Response(response=201, description="Created", @OA\JsonContent(ref="#/components/schemas/Review"))
     * )
     */
     ...
     *   @OA\Response(response=200, description="OK", @OA\JsonContent(ref="#/components/schemas/Review")),
    ...
    public function show(string $id): JsonResponse
    {
        ...
        return $data
            ? response()->json($data)
            : response()->json(['message' => 'Review not found'], Response::HTTP_NOT_FOUND);
    }
